...
(let* ((foreground "#2AEA7D")
       (background "#0E1712")
       (spec "#123621")
       (selection_color "#148846")
       (black "#0A110D")
       (red "#E64343")
       (green "#2AEA3B")
       (yellow "#7DEA2A")
  ...
  (custom-theme-set-faces
   ...
   ;;test
;;   `(css-fontify-colors ((t (:foreground))) (t :inverse-video t))
   
   ;; Line number
   `(line-number-current-line ((t (:background,spec :foreground,yellow ))))
   `(line-number ((t (:background ,spec :foreground,foreground ))))

   ; Selector on frame, while you use swiper!
   `(highlight ((t (:background ,yellow :foreground, black)))) ;; <- after changing this to white
   
   ;ivy, swiper
   `(ivy-current-match ((t (:background ,magenta :foreground,black ))))
   `(ivy-minibuffer-match-face-2 ((t (:background,selection_color :foreground, foreground))))
   ;;`(ivy-minibuffer-match-face-2 ((t (:background,light-gray :foreground, white))))
   `(ivy-minibuffer-match-face-3 ((t (:background,red :foreground, white))))
   ...
   `(mode-line-inactive
     ((t (:foreground ,green
                      :background ,background
                      :box (:line-width -1 :style released-button)))))
   `(region ((t (:background ,selection_color))
             (t :inverse-video t)))
   ...
   ;; ivy, swiper
   ;(set-face-foreground 'ivy-current-match green)
   ...
   ;; hl-line-mode
   ;`(hl-line-face ((t (:background ,black :foreground, white))
   ;                (t :weight bold)))
   ;`(hl-line ((t (:background ,black, :foreground, white)) ; old emacsen
   ;           (t :weight bold)))

   ;; hl-line-mode
   `(hl-line-face ((t (:background ,spec :foreground, white))
                   (t :weight bold)))
   `(hl-line ((t (:background ,spec, :foreground, foreground))
              (t :weight bold)))
